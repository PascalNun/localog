...
pub(crate) struct Introduction {
    ...
    /// point: a person recognises "Kaulins Applinsky" as themselves at once, and the
...
impl OllamaProvider {
    ...
    ///
    /// Every name comes back wrong on a first meeting — "Kaulins Applinsky",
    /// "Markus Gröber", "Johannes Kreuz von Kau, drei" — and that is what makes this
    ...
    /// transcriber was unsure of, and it was perfectly confident about "Marianne".
        ...
        "properties": {
            "introductions": {
                ...
                "items": {
                    ...
                    // to recognise: "Marianne" could be anybody, and "Marianne, die
